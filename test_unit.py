...
class TestBooksCollector:
    ...
    def test_books_rating_is_dict(self):
        # что бы сделать каждый тест независимым создаю обьект класса в каждом методе
        col_book = BooksCollector()
    ...
    def test_add_new_book_name_book_will_add(self, name_book):
        ...
        assert "Унесенные ветром" in col_book.books_rating and col_book.books_rating.get("Унесенные ветром") == 1
    ...
    def test_set_book_rating_name_rating_get_actual_rating(self, name_book, rating_book):
        ...
        assert col_book.books_rating.get("Унесенные ветром") == 6
    ...
    def test_get_books_with_specific_rating_rating_get_list_with_names_of_books(self, rating_book, name_book):
        col_book = BooksCollector()
        col_book.add_new_book(name_book)
        col_book.add_new_book("Цветы для Элджернона")
        col_book.set_book_rating(name_book, rating_book)
    ...
    def test_get_list_of_favorites_books(self, name_book):
        col_book = BooksCollector()
        col_book.add_new_book(name_book)
        col_book.add_book_in_favorites(name_book)
        assert type(col_book.favorites) == list and len(col_book.favorites) == 1
